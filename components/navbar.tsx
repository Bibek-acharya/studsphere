...
import { Search, Bell, X, GraduationCap, Code, Briefcase, Clock, Calendar, ChevronDown, Menu } from "lucide-react";
...
import rectangleEducation from '@/public/Rectangle 2.png';
import rectangleJobs from '@/public/Rectangle 2 (1).png';
import rectangleEvents from '@/public/Rectangle 2 (2).png';
import rectangleInstitutions from '@/public/Rectangle 3 (1).png';
import rectangleEmployer from '@/public/Rectangle 3 (1).png';
...
export function Navbar() {
  ...
  // dropdown open states so we can close them on navigation
            ...
            <DropdownMenu open={exploreOpen} onOpenChange={setExploreOpen}>
               ...
               <DropdownMenuContent align="center" className="w-screen p-3 md:p-6 rounded-none border-t-0">
                 <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-[1fr_1fr_1fr_200px] gap-2 md:gap-4 h-auto md:h-[250px]">
                  ...
                  <Link href="/jobs" onClick={() => setExploreOpen(false)}>
                     <div className="group relative overflow-hidden rounded-lg cursor-pointer h-full">
                      <div className="relative h-full">
                        <Image
                          src={rectangleJobs}
                  ...
                  <div className="col-span-2 md:col-span-3 lg:col-span-1 flex md:flex-col gap-2 md:gap-3">
                    <Link href="/institutions" onClick={() => setExploreOpen(false)}>
                      <div className="group relative overflow-hidden rounded-lg cursor-pointer">
                        <div className="aspect-[4/2.5] relative">
                          <Image
                            src={rectangleInstitutions}
                            alt="Institutions"
                            fill
                            className="object-cover"
                          />
                    ...
                    <Link href="/jobs/employer" onClick={() => setExploreOpen(false)}>
                      <div className="group relative overflow-hidden rounded-lg cursor-pointer">
                        <div className="aspect-[4/2.5] relative">
                          <Image
                            src={rectangleEmployer}
                            alt="Employer"
                            fill
                            className="object-cover"
                          />
            ...
            <DropdownMenu open={moreOpen} onOpenChange={setMoreOpen}>
              ...
              <DropdownMenuContent align="start">
                <DropdownMenuItem asChild>
                  <Link href="/contact" onClick={() => setMoreOpen(false)} className="cursor-pointer">
                    Contact us
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/services" onClick={() => setMoreOpen(false)} className="cursor-pointer">
                    Our Services
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/advertise" onClick={() => setMoreOpen(false)} className="cursor-pointer">
                    Advertise with us
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/partner" onClick={() => setMoreOpen(false)} className="cursor-pointer">
                    Partner with us
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
            ...
            <div className="px-3 py-4 space-y-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start" className="w-[calc(100vw-24px)]">
                  <div className="grid grid-cols-2 gap-2 p-2">
                    ...
                    <Link href="/institutions" onClick={() => setIsMobileMenuOpen(false)}>
                      <div className="group relative overflow-hidden rounded-lg cursor-pointer">
                        <div className="aspect-video relative">
                          <Image
                            src={rectangleInstitutions}
                    ...
                    <Link href="/employer" onClick={() => setIsMobileMenuOpen(false)}>
                      <div className="group relative overflow-hidden rounded-lg cursor-pointer">
                        <div className="aspect-video relative">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-2 text-white">
                            <h3 className="text-xs font-bold">For Employer</h3>
                            <p className="text-[10px] text-white/90">Employer solutions</p>
                          </div>
                        </div>
                      </div>
                    </Link>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start" className="w-56">
                  <DropdownMenuItem asChild>
                    <Link href="/contact" onClick={() => setIsMobileMenuOpen(false)} className="cursor-pointer">
                      Contact us
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/services" onClick={() => setIsMobileMenuOpen(false)} className="cursor-pointer">
                      Our Services
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/advertise" onClick={() => setIsMobileMenuOpen(false)} className="cursor-pointer">
                      Advertise with us
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/partner" onClick={() => setIsMobileMenuOpen(false)} className="cursor-pointer">
                      Partner with us
                    </Link>
                  </DropdownMenuItem>
                </DropdownMenuContent>
